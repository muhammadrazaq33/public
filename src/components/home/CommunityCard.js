...
const data = [
  {
    ...
    subHeading: "FAMILIES",
    description:
      "1 in 3 families Go into debt to maintain communication with their loved ones.",
  },
  {
    heading: "83%",
    subHeading: "WOMEN",
  ...
  },
  {
    ...
    subHeading: "SPENT",
    description:
      "Annually Families spend $3 billion on commissary accounts and phone calls.",
  },
];
      ...
      <div className="bg-[#033F91] w-full rounded-[24px] px-[30px] pt-[30px] gap-[30px] grid grid-cols-1 lg:grid-cols-2 ">
        ...
        <div className="flex flex-col gap-[20px]">
          ...
          <p className="lg:text-[18px] text-white">
            A secured credit card designed to help the families and friends of
            incarcerated individuals build credit by leveraging recurring
            commissary and telecommunication payments.
          </p>
