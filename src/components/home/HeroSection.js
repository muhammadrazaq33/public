...
export const HeroSection = () => {
  return (
    <div
      ...
      style={{
        backgroundImage: "linear-gradient(180deg, #0451B0 44%, #0451B0 100%)",
      }}
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-[40px]  ">
          <div className="flex flex-col gap-[30px]">
            ...
            <div className="px-[16px] hidden lg:block border text-white border-white rounded-[24px] w-[99px] text-center">
              <h6 className="font-semibold uppercase">Mission</h6>
            </div>
            <p className="text-white hidden lg:block font-normal lg:text-[20px]">
              Parish fosters economic mobility for justice-impacted communities
              by empowering returning citizens, the family members of
              incarcerated individuals, and with innovative and inclusive
